// NOTE: CheckoutForm has been removed as requested.
// This file is intentionally stubbed to return null to avoid import errors.
export function CheckoutForm() {
  return null;
}

// The original implementation is archived in CheckoutForm.removed.md.
  useEffect(() => {
        ...
        <div>
          ...
          {mapError ? (
            <div className="w-full h-80 flex items-center justify-center bg-gray-50 border border-gray-200 rounded-lg">
              <p className="text-xs text-talla-text/50">Map unavailable — you can continue to checkout and provide your delivery address on the next page.</p>
            </div>
          ) : (
...
// The CheckoutForm component has been removed by request. If any files still import
// this component, they should be updated to redirect users directly to the
// Shopify hosted checkout using `cart.checkoutUrl`.
